...
namespace E_Commerce.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        public Tbl_Entity GetFirstorDefault(InterfaceTypeAttribute recordId)
        {
        ...
        {
           if(_DBEntity.Entry(entity).State == System.Data.Entity.EntityState.Detached)_dbSet.Attach(entity);
        ...
        public void Update(Tbl_Entity entity)
        {
            ...
            _DBEntity.Entry(entity).State = System.Data.Entity.EntityState.Modified;
            _DBEntity.SaveChanges();
        }
        ...
        public object GetFirstorDefault(int recordId)
        {
            return _dbSet.Find(recordId);
        }
